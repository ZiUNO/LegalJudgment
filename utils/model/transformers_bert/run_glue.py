...
""" Finetuning the library model for sequence classification on GLUE (Bert, XLM, XLNet, RoBERTa)."""
...
from transformers import DataProcessor, InputExample  # 导入DataProcessor InputExample
...
output_modes["self"] = "classification"  # 在output_modes中加入self任务
processors["self"] = SelfProcessor  # 在processors中加入self
