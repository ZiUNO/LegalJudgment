...
def convert_pt_checkpoint_to_tf(model_type, pytorch_checkpoint_path, config_file, tf_dump_path, compare_with_pt_model=False, use_cached_models=True):
    ...
    if compare_with_pt_model:
        ...
        print("Max absolute difference between model outputs {}".format(diff))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type",
                        default = None,
                        type = str,
                        help = "Model type selected in the list of {}. If not given, will download and convert all the model from AWS.".format(list(MODEL_CLASSES.keys())))
    ...
    parser.add_argument("--use_cached_models",
                        action='store_true',
                        help = "Use cached model if possible instead of updating to latest checkpoint versions.")
    parser.add_argument("--only_convert_finetuned_models",
                        action='store_true',
                        help = "Only convert finetuned model.")
