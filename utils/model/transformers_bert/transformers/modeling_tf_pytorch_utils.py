...
def load_pytorch_weights_in_tf2_model(tf_model, pt_state_dict, tf_inputs=None, allow_missing_keys=False):
    ...
    # Make sure we are able to load PyTorch base model as well as derived model (with heads)
    # TF model always have a prefix, some of PyTorch model (base ones) don't
