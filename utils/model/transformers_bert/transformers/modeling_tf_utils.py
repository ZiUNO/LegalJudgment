...
class TFPreTrainedModel(tf.keras.Model):
    r""" Base class for all TF model.

        :class:`~transformers.TFPreTrainedModel` takes care of storing the configuration of the model and handles methods for loading/downloading/saving model
